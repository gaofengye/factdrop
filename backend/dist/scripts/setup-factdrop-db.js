...
async function createDatabaseIfNotExists() {
    ...
    try {
        const checkResult = await adminClient.query("SELECT 1 FROM pg_database WHERE datname = $1", [DB_NAME]);
...
async function createTableAndInsertDomains() {
    ...
    `);
        ...
        const result = await appClient.query("SELECT id, name, created_at FROM domains ORDER BY id ASC");
        console.log("\nSaved domains:");
...
main();
//# sourceMappingURL=setup-factdrop-db.js.map